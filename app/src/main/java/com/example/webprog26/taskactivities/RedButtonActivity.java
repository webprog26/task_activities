...
public class RedButtonActivity extends ParentActivity {

    //NOTE! Use RedButtonActivity_TAG to see logs of activity's lifecycle
    ...
    protected int getContentViewResId() {
        return R.layout.activity_red_button;
    }
